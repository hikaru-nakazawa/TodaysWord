class TodaysController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @today.save
        ...
        format.json { render :show, status: :created, location: @today }
      else
  ...
  def update
    respond_to do |format|
      if @today.update(today_params)
        ...
        format.json { render :show, status: :ok, location: @today }
      else
  ...
  def destroy
    @today.destroy
    respond_to do |format|
      format.html { redirect_to todays_url, notice: 'Today was successfully destroyed.' }
  ...
  private
    ...
    def today_params
      params.require(:today).permit(:author, :words)
    end
end
